...
class ConversationTableViewCell: CollapsibleTableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        textLabel.leadingAnchor.constraint(equalTo: photoImageView.trailingAnchor, constant: Constants.leadingMessageAnchorConstant).isActive = true
        ...
        textLabel.font = UIFont.systemFont(ofSize: Constants.messageTextFontSize)
